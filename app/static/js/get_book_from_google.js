            ...
            $.getJSON("https://www.googleapis.com/books/v1/volumes?q=" + isbn)
                .done(function (data) {
                    ...
                    if (data.code) {//There is a situation
                        ...
                        document.getElementById('bookValue').value = data.items[0].volumeInfo.bookValue;
                        ...
                        document.getElementById('collateral_value').value = data.items[0].volumeInfo.collateral_value;
